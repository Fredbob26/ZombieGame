...
public class Kit_PvE_ZombieWaveSurvival_EditorWeaponPurchase : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (spawner.main)
        {
            ...
            {
                Kit_ModernWeaponScript ws = spawner.main.gameInformation.allWeapons[spawner.weaponToBuy] as Kit_ModernWeaponScript;
                ...
                if (ws.attachmentSlots.Length != spawner.weaponToBuyAttachments.Length)
                {
                    //Create new array
                    spawner.weaponToBuyAttachments = new int[ws.attachmentSlots.Length];
                }
                ...
                for (int o = 0; o < spawner.weaponToBuyAttachments.Length; o++)
                {
                    ...
                    GUILayout.Label("Attachment selected in slot [" + o + "]: " + ws.attachmentSlots[o].availableAttachments[spawner.weaponToBuyAttachments[o]].name);

                    spawner.weaponToBuyAttachments[o] = EditorGUILayout.IntSlider("Attachment ID: ", spawner.weaponToBuyAttachments[o], 0, ws.attachmentSlots[o].availableAttachments.Length - 1);
